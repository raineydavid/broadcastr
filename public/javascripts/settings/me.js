...
ws.onopen = function(event){
    ...
    switch(dataId){
      ...
      var body = d3.select("body")
        navBar(body,data,function(d){
          ws.send(JSON.stringify({type:"email",id:"send"}))
        })
      break;
      case "data":
        ...
        },
        {
          ...
          fields:[
            ...
            },
            {
              ...
              element:"button",
              class:"col-xs-4",
              elementClass:"btn btn-default accentGreen-500"
            }]
        }
      ]
  ...
  var nav = contentDiv.append("div")
    ...
    userTables = userDivs.append("div")
    ...
    userTables.append("tbody")
      .selectAll("tr")
      .data(function(d){
        return data.employees.filter(function(a){
...
var userInactiveForms = userTables.filter(function(d){
  return d.data.link === "activeEmployees"
...
var userActiveForms = userTables.filter(function(d){
  return d.data.link === "inactiveEmployees"
}).select("tbody").selectAll("td").filter(function(d){
  return d.col.name==="active"
}).append("form")
