    ...
    function(tokenCb){
      async.eachLimit(recip,1,function(d,callback){
        ...
        async.series([
          ...
          function(seriesCb){
            client.query("INSERT INTO echo.activity_logs (timestamp,datecode,sender_id,sender_email,body,recipient_email,action,client_id) VALUES (current_timestamp,$1,$2,$3,$4,$5,'send',$6)",[uncodedDate,user.id,user.email,uniqueBody,d.email,client.client_id],function(queryErr){
